...
ck( 'by the sync, with no author and the company\'s title', array( $GLOBALS['sideloads'][0][2], $GLOBALS['sideloads'][0][3] ), array( 0, 'Mango Example logo (colour)' ) );
...
ck( 'the card prints the mentors and the counts, and the one looking with a form', false !== strpos( $html, 'Ines Example' ) && false !== strpos( $html, 'Ana Looking' ) && false !== strpos( $html, 'Polyglots' ) && 1 === substr_count( $html, 'value="' . WPCPM_Sponsor_Mentors::ACTION_INTEREST_MENTOR . '"' ), true );

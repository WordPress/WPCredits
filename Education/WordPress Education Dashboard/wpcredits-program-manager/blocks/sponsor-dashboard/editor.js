/**
 * Editor script for the "Sponsor Dashboard" block.
 *
...
( function ( blocks, blockEditor, components, element, i18n, serverSideRender ) {
	...
	blocks.registerBlockType( 'wpcpm/sponsor-dashboard', {
		edit: function ( props ) {
			...
			return el(
				...
				el(
					...
					null,
					el( ServerSideRender, {
						block: 'wpcpm/sponsor-dashboard',
						attributes: props.attributes,
						EmptyResponsePlaceholder: function () {
							return el(
								components.Placeholder,
								{ label: __( 'Sponsor Dashboard', 'wpcredits-program-manager' ) },
								__(
									'The Sponsor Dashboard renders here for a signed-in sponsor.',

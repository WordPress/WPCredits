/**
 * Editor script for the "Institution Dashboard" block.
 *
...
( function ( blocks, blockEditor, components, element, i18n, serverSideRender ) {
	...
	blocks.registerBlockType( 'wpcpm/institution-dashboard', {
		edit: function ( props ) {
			...
			return el(
				...
				el(
					...
					null,
					el( ServerSideRender, {
						block: 'wpcpm/institution-dashboard',
						attributes: props.attributes,
						EmptyResponsePlaceholder: function () {
							return el(
								components.Placeholder,
								{ label: __( 'Institution Dashboard', 'wpcredits-program-manager' ) },
								__(
									'Nothing to preview - this page is built from the institution the person viewing it acts for.',
